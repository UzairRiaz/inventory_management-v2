...
export default function OrgLogin() {
  ...
  return (
    <Screen>
      <Section title="Organization Login" icon="ORG">
        <form onSubmit={onSubmit}>
          <label className="field-label">Organization Code</label>
          <input className="input" value={organizationCode} onChange={(e) => setOrganizationCode(e.target.value)} placeholder="Organization code" />
