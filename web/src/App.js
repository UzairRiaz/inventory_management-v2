...
import Customers from './pages/org/Customers';
import CustomerAccount from './pages/org/CustomerAccount';
...
import VendorsSetup from './pages/org/setup/VendorsSetup';
    ...
    <header className="top-bar">
      ...
      {token ? (
        <div className="actions-row">
          <div className="top-bar-user-meta">{user?.name || 'User'}</div>
          <button className="btn ghost top-bar-logout" onClick={signOut}>Logout</button>
        </div>
      ) : null}
    </header>
  );
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="customers/:customerId" element={<CustomerAccount />} />
        <Route path="setup/sales" element={<Sales />} />
        <Route path="setup/sales/new" element={<SalesCreate />} />
        <Route path="setup/payments" element={<Payments />} />
        <Route path="setup/payments/new" element={<PaymentsCreate />} />
        <Route path="sales" element={<Navigate to="/org/setup/sales" replace />} />
        <Route path="sales/new" element={<Navigate to="/org/setup/sales/new" replace />} />
        <Route path="payments" element={<Navigate to="/org/setup/payments" replace />} />
        <Route path="payments/new" element={<Navigate to="/org/setup/payments/new" replace />} />
        <Route path="customer-sales" element={<Navigate to="/org/customers" replace />} />
        ...
        <Route path="setup/vendors" element={<VendorsSetup />} />
